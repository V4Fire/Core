!function (e, t) {
		...
		for (e in d = se.support = {}, i = se.isXML = function (e) {
			...
			return r !== C && 9 === r.nodeType && r.documentElement && (a = (C = r).documentElement, E = !i(C), m !== C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener('unload', oe, !1) : n.attachEvent && n.attachEvent('onunload', oe)), d.attributes = ce(function (e) {
				...
				t.setAttribute('type', 'hidden'), e.appendChild(t)
					.setAttribute('name', 'D'), e.querySelectorAll('[name=d]').length && v.push('name' + M + '*[*^$|!~]?='), 2 !== e.querySelectorAll(':enabled').length && v.push(':enabled', ':disabled'), a.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(':disabled').length && v.push(':enabled', ':disabled'), e.querySelectorAll('*,:x'), v.push(',.*:');
	...
	me = E.createDocumentFragment()
		.appendChild(E.createElement('div')), (xe = E.createElement('input')).setAttribute('type', 'radio'), xe.setAttribute('checked', 'checked'), xe.setAttribute('name', 't'), me.appendChild(xe), y.checkClone = me.cloneNode(!0)
		.cloneNode(!0).lastChild.checked, me.innerHTML = '<textarea>x</textarea>', y.noCloneChecked = !!me.cloneNode(!0).lastChild.defaultValue;
	var Te = /^key/,
		...
		global: {}, add: function (t, e, n, r, i) {
			...
			if (v) {
				for (n.handler && (n = (o = n).handler, i = o.selector), i && k.find.matchesSelector(ie, i), n.guid || (n.guid = k.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function (e) {
					...
					d = g = (s = Ee.exec(e[l]) || [])[1], h = (s[2] || '').split('.')
			...
			if (v && (u = v.events)) {
				for (l = (t = (t || '').match(R) || ['']).length; l--;) {
					if (d = g = (s = Ee.exec(t[l]) || [])[1], h = (s[2] || '').split('.')
						.sort(), d) {
			...
			if (u && l.nodeType && !('click' === e.type && 1 <= e.button)) {
				for (; l !== this; l = l.parentNode || this) {
					if (1 === l.nodeType && ('click' !== e.type || !0 !== l.disabled)) {
						for (o = [], a = {}, n = 0; n < u; n++) {
							void 0 === a[i = (r = t[n]).selector + ' '] && (a[i] = r.needsContext ? -1 < k(i, this)
								.index(l) : k.find(i, this, null, [l]).length), a[i] && o.push(r);
						}
	...
	k.Animation = k.extend(dt, {
		...
		.appendChild(E.createElement('option')), ot.type = 'checkbox', y.checkOn = '' !== ot.value, y.optSelected = at.selected, (ot = E.createElement('input')).value = 't', ot.type = 'radio', y.radioValue = 't' === ot.value;
	var ht,
	...
	k.fn.extend({
		...
		attr: function (e, t, n) {
			var r,
				...
				o = e.nodeType;
			if (3 !== o && 8 !== o && 2 !== o) {
				return void 0 === e.getAttribute ? k.prop(e, t, n) : (1 === o && k.isXMLDoc(e) || (i = k.attrHooks[t.toLowerCase()] || (k.expr.match.bool.test(t) ? ht : void 0)), void 0 !== n ? null === n ? void k.removeAttr(e, t) : i && 'set' in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ''), n) : i && 'get' in i && null !== (r = i.get(e, t)) ? r : null == (r = k.find.attr(e, t)) ? void 0 : r);
			}
		}, attrHooks: {
			type: {
				set: function (e, t) {
	...
	k.fn.extend({
		...
		k.valHooks[this] = {
			set: function (e, t) {
				if (Array.isArray(t)) {
					return e.checked = -1 < k.inArray(k(e)
						.val(), t);
				}
			},
	...
	Ft.href = Et.href, k.extend({
		...
		ajax: function (e, t) {
			...
			if (x.promise(T), v.url = ((e || v.url || Et.href) + '').replace(Mt, Et.protocol + '//'), v.type = t.method || t.type || v.method || v.type, v.dataTypes = (v.dataType || '*').toLowerCase()
	...
	k.ajaxSetup({
		...
		return 'string' != typeof e ? [] : ('boolean' == typeof t && (n = t, t = !1), t || (y.createHTMLDocument ? ((r = (t = E.implementation.createHTMLDocument('')).createElement('base')).href = E.location.href, t.head.appendChild(r)) : t = E), o = !n && [], (i = D.exec(e)) ? [t.createElement(i[1])] : (i = we([e], t, o), o && o.length && k(o)
			...
			if (this[0]) {
				...
				if ('fixed' === k.css(r, 'position')) {
					...
					e && e !== r && 1 === e.nodeType && ((i = k(e)
						.offset()).top += k.css(e, 'borderTopWidth', !0), i.left += k.css(e, 'borderLeftWidth', !0));
				}
	...
	var _ = e.Collection = function (t, e) {
			e || (e = {}), this.preinitialize.apply(this, arguments), e.model && (this.model = e.model), void 0 !== e.comparator && (this.comparator = e.comparator), this._reset(), this.initialize.apply(this, arguments), t && this.reset(t, i.extend({silent: !0}, e));
		},
		...
		model: m, preinitialize: function () {
			...
			if (null != t) {
				...
				if (s.length && E ? (w = this.length !== s.length || i.some(this.models, function (t, e) {
					return t !== s[e];
				}), this.models.length = 0, x(this.models, s, 0), this.length = this.models.length) : a.length && (v && (d = !0), x(this.models, a, null == r ? this.length : r), this.length = this.models.length), d && this.sort({silent: !0}), !e.silent) {
	...
	i.each([[_, {
		...
		findIndex: 3,
		findLastIndex: 3,
	}, 'models'], [m, {keys: 1, values: 1, pairs: 1, invert: 1, pick: 0, omit: 0, chain: 1, isEmpty: 1}, 'attributes']], function (t) {
		var e = t[0],
			n = t[1],
			r = t[2];
		e.mixin = function (t) {
		...
		if (r.url || (a.url = i.result(n, 'url') || V()), null != r.data || !n || 'create' !== t && 'update' !== t && 'patch' !== t || (a.contentType = 'application/json', a.data = JSON.stringify(r.attrs || n.toJSON(r))), r.emulateJSON && (a.contentType = 'application/x-www-form-urlencoded', a.data = a.data ? {model: a.data} : {}), r.emulateHTTP && ('PUT' === s || 'DELETE' === s || 'PATCH' === s)) {
	...
	B.started = !1, i.extend(B.prototype, a, {
		interval: 50, atRoot: function () {
			...
			return this.decodeFragment(this.location.pathname)
				.slice(0, this.root.length - 1) + '/' === this.root;
			...
			if (this._usePushState ? s('popstate', this.checkUrl, !1) : this._useHashChange && !this.iframe ? s('hashchange', this.checkUrl, !1) : this._wantsHashChange && (this._checkUrlInterval = setInterval(this.checkUrl, this.interval)), !this.options.silent) {
				return this.loadUrl();
			}
		}, stop: function () {
	...
	e.version = '2.3.7', e.utils = {}, e.utils.warn = function (e) {
		...
		return t === e.Set.complete ? e.Set.complete : t === e.Set.empty ? this : new e.Set(Object.keys(this.elements)
		...
		if (Array.isArray(t)) {
			return t.map(function (t) {
				return new e.Token(e.utils.asString(t)
					.toLowerCase(), e.utils.clone(r));
			});
		}
		for (var i = t.toString()
			.toLowerCase(), n = i.length, s = [], o = 0, a = 0; o <= n; o++) {
			var l = o - a;
			if (i.charAt(o)
				.match(e.tokenizer.separator) || o == n) {
				if (0 < l) {
		...
		for (var t = 0, r = this.elements.length / 2, i = r - t, n = Math.floor(i / 2), s = this.elements[2 * n]; 1 < i && (s < e && (t = n), e < s && (r = n), s != e);) {
		...
		for (var e = this.final ? '1' : '0', t = Object.keys(this.edges)
			.sort(), r = t.length, i = 0; i < r; i++) {
			var n = t[i];
		...
		this.tokenSet = e.TokenSet.fromArray(Object.keys(this.invertedIndex)
			.sort());
...
!function (typedoc) {
	...
	var Application = function (_super) {
		...
		return __extends(Application, _super), Application.prototype.createServices = function () {
			...
			return _(components)
				.forEach(function (c) {
					c.namespace != namespace && '*' != c.namespace || $context.find(c.selector)
						.each(function (m, el) {
							var instance,
								$el = $(el);
							(instance = $el.data('component')) ? -1 == _(result)
								.indexOf(instance) && result.push(instance) : (instance = new c.constructor({el: el}), $el.data('component', instance), result.push(instance));
						});
				}), result;
		}, Application;
	}(typedoc.Events);
			...
			return __extends(FilterItemSelect, _super), FilterItemSelect.prototype.initialize = function () {
				...
				typedoc.$html.addClass('toggle-' + this.key + this.value), this.$select = $('#tsd-filter-' + this.key), this.$select.on(typedoc.pointerDown + ' mouseover', function () {
					...
					.on(typedoc.pointerUp, 'li', function (e) {
						_this.$select.removeClass('active'), _this.setValue(($(e.target)
				...
				this.$select.find('li.selected')
					.removeClass('selected'), this.$select.find('.tsd-select-label')
					.text(this.$select.find('li[data-value="' + newValue + '"]')
						.addClass('selected')
						.text()), typedoc.$html.removeClass('toggle-' + oldValue), typedoc.$html.addClass('toggle-' + newValue);
	...
	var MenuHighlight = function (_super) {
		...
		return __extends(MenuHighlight, _super), MenuHighlight.prototype.createAnchors = function () {
			...
			-1 != base.indexOf('#') && (base = base.substr(0, base.indexOf('#'))), this.$el.find('a')
			...
			for (scrollTop += 5; 0 < index && anchors[index].position > scrollTop;) {
				index -= 1;
			}
	...
	!function (search) {
		...
		function loadIndex() {
			...
			}, 500), void 0 !== search.data ? createIndex() : $.get($el.attr('data-index'))
		...
		function setCurrentResult(dir) {
			...
			if (0 == $current.length) {
				$results.find(1 == dir ? 'li:first-child' : 'li:last-child')
					.addClass('current');
			} else {
		...
		function gotoCurrentResult() {
			var $current = $results.find('.current');
			0 == $current.length && ($current = $results.find('li:first-child')), 0 < $current.length && (window.location.href = $current.find('a')
				.prop('href'), $field.blur());
		}
	...
	typedoc.transition = function (tuples) {
		...
		noTransition($el, function () {
			...
			noTransition($el, function () {
				$el.off(typedoc.transition.endEvent)
					.css("height", ""), success && success()
			})
		})) : success && success()
	}
}(typedoc || (typedoc = {})), function (typedoc) {
	var SignatureGroup = function () {
		...
		Signature = function (_super) {
			function Signature(options) {
				var _this = _super.call(this, options) || this;
				return _this.groups = [], _this.index = -1, _this.createGroups(), _this.$container && (_this.$el.addClass("active")
					...
					if (-1 < this.index) {
						...
						typedoc.animateHeight(this.$container, function () {
							from.removeClass("current")
								.addClass("fade-out"), to.addClass("current fade-in"), typedoc.viewport.triggerResize()
						}), setTimeout(function () {
			...
			if (!typedoc.hasPointerMoved && this.active) {
				...
				if ($path.hasClass("col-menu")) {
					...
					if ($link.length) {
						...
						-1 != href.indexOf("#") && (href = href.substr(0, href.indexOf("#"))), $link.prop("href")
							.substr(0, href.length) == href && setTimeout(function () {
