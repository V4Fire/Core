...
describe('core/iter/combinators', () => {
  describe('sequence', () => {
    it('sequence of sync iterators', () => {
      const s = (0, _combinators.seq)([1, 2], new Set([3, 4]), [5, 6].values());
    ...
    it('sequence of async iterators', async () => {
      ...
      const s = (0, _combinators.seq)((0, _stream.assemble)((0, _stream.pick)(tokens, 'total')), (0, _stream.streamArray)((0, _stream.andPick)(tokens, 'data')));
      const res = [];
