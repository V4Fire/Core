...
export declare abstract class AbstractPersistentEngine<V = unknown> {
    /**
     ...
     */
    protected readonly pending: Map<string, Promise<unknown>>;
     ...
     */
    protected execTask<T>(key: string, task: () => CanPromise<T>): Promise<T>;
}
export declare abstract class CheckablePersistentEngine<V = unknown> extends AbstractPersistentEngine<V> {
    /**
 ...
 */
export declare abstract class UncheckablePersistentEngine<V = unknown> extends AbstractPersistentEngine<V> {
 ...
 */
export declare type PersistentEngine<V = unknown> = CheckablePersistentEngine<V> | UncheckablePersistentEngine<V>;
/**
 ...
 */
export declare type StorageCheckState = {
    available: false;
    checked: boolean;
} | {
    available: true;
