...
export declare type MethodsToWrap = 'set' | 'remove' | 'clear';
...
export declare type AddEmitter = <T extends Cache<V, K>, V = unknown, K extends string = string>(cache: T) => AddEmitterReturn<T>;
