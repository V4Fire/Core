 ...
 */
export declare type ControllablePromise<P extends PromiseLike<any> = Promise<unknown>> = P & {
    /**
...
export interface ControllablePromiseExecutor<T = unknown> {
    (resolve: ControllablePromiseResolveHandler<T>, reject: ControllablePromiseRejectHandler, ...args: any[]): void;
}
...
export interface CreateControllablePromiseOptions<T extends ControllablePromiseConstructor> {
     ...
     * @param args
     */
    executor?(resolve: ControllablePromiseResolveHandler, reject: ControllablePromiseRejectHandler, ...args: any[]): void;
    /**
