...
describe('middlewares/errors-deduplicator', () => {
  ...
  describe('factory', () => {
    it('has "errorsDeduplicator" instance', () => {
      expect('errorsDeduplicator' in _middlewares.default).toBeTrue();
    });
    it('"errorsDeduplicator" is instance of ErrorsDeduplicatorMiddleware', () => {
      expect(_middlewares.default.errorsDeduplicator() instanceof _errorsDeduplicator.ErrorsDeduplicatorMiddleware).toBeTrue();
    });
  });
});