...
describe('core/prelude/object/mixin', () => {
  it('simple extending of an object', () => {
    ...
    const clone = Object.mixin(false, {}, base);
  ...
  it('simple extending of an object without specifying the base object', () => {
    ...
    const clone = Object.mixin(false, undefined, base);
    expect(clone).not.toBe(base);
    expect(clone).toEqual(base);
  });
  ...
  it('simple extend of a weak map', () => {
    const key1 = Object(0),
          key2 = Object(1);
    const base = new Map([[key1, 1], [key2, 2]]),
  ...
  it('extending of an object with undefined fields', () => {
    ...
    const clone1 = Object.mixin(false, undefined, base);
    expect(clone1).not.toBe(base);
    expect(clone1).toEqual({
      a: 1,
      b: 2
    });
    const clone2 = Object.mixin({
      skipUndefs: false
    }, undefined, base);
  ...
  it('extending of an object with accessors', () => {
    ...
    const clone = Object.mixin({
      withDescriptors: 'onlyAccessors'
    }, undefined, base);
    expect(clone).not.toBe(base);
  ...
  it('extending of an object with the prototype', () => {
    ...
    const base1 = Object.create(proto);
    ...
    const base2 = Object.create(proto);
    Object.mixin({
      deep: true,
      withProto: true
    }, base2, {
    ...
    const base3 = Object.create(proto);
    Object.mixin({
      deep: true,
      withProto: true
    }, base3, {
    ...
    const base4 = Object.create(proto);
    Object.mixin({
      deep: true
    }, base4, {
      a: 2,
  ...
  it('deep extending with not own properties', () => {
    expect(Object.mixin(false, {}, {
      __proto__: {
        a: 1
      }
    })).toEqual({});
    expect(Object.mixin(true, {}, {
      __proto__: {
        a: 1
      }
    })).toEqual({
  ...
  it('deep extending with non-enumerable properties', () => {
    ...
    Object.defineProperty(base.b, 'd', {
      value: 3
    });
  ...
  it('deep extending with preserving descriptors and concatenation of arrays', () => {
    const obj1 = {
      a: [1, 2, 3]
    },
          obj2 = {};
  ...
  it('deep extending with the custom array concatenation', () => {
    ...
    const concatFn = (a, b) => [...new Set(a.concat(b))];

    Object.mixin({
      deep: true,
      concatArrays: concatFn
    }, base, {
      a: [2, 3, 4]
    });
    expect(base).toEqual({
  ...
  it('deep extending with the custom extend filter', () => {
    ...
    const extendFilter = val => !(val instanceof Set);
