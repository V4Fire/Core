...
describe('core/prelude/object/property/get', () => {
  ...
  it('get a value through a promise', async () => {
    ...
    }, 'a.then')).toBe(Promise.prototype.then);
    expect(await Object.get({
      a: Promise.resolve({
        b: 3
      })
    }, 'a.b')).toBe(3);
...
describe('core/prelude/object/property/hasOwnProperty', () => {
  ...
  it('functional overloads', () => {
    ...
    expect(Object.hasOwnProperty('a')({
      __proto__: {
        a: 1
      }
    })).toBe(false);
...
describe('core/prelude/object/property/set', () => {
  ...
  it('custom separator', () => {
    ...
    expect(Object.set(obj, 'a:b', 2, {
      separator: ':'
    })).toBe(2);
    expect(Object.get(obj, 'a:b', {
      separator: ':'
    })).toBe(2);
  });
  ...
  it('functional overloads', () => {
    ...
    expect(Object.set(obj)('a', 2)).toEqual({
      a: 2
    });
    expect(Object.get(obj, 'a')).toBe(2);
    expect(Object.set('a')(obj, 3)).toEqual({
      a: 3
    });
    expect(Object.get(obj, 'a')).toBe(3);
    expect(Object.set(obj, {
      separator: ':'
    })('b:c', 4)).toEqual({
      a: 3,
      b: {
...
describe('core/prelude/object/property/delete', () => {
  ...
  it('functional overloads', () => {
    ...
    expect(Object.delete('a')({
      a: 1
    })).toBe(true);
    expect(Object.delete('a:b', {
      separator: ':'
    })({
      a: {
        b: 1
