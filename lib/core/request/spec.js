...
describe('core/request', () => {
  const engines = new Map([['node', _fetch.default], ['fetch', _fetch.default], ['xhr', _xhr.default], ['provider', (0, _provider.default)('Provider')], ['chain provider', (0, _provider.default)(TestRequestChainProvider)]]);
