...
export declare type RequestMethod = 'GET' | 'POST' | 'PUT' | 'DELETE' | 'PATCH' | 'HEAD' | 'CONNECT' | 'OPTIONS' | 'TRACE';
export declare type CacheStrategy = 'queue' | 'forever' | 'never' | AbstractCache | Promise<AbstractCache>;
export declare type CacheType = 'memory' | 'offline';
...
export declare type Middlewares<D = unknown> = Dictionary<Middleware<D>> | Iterable<Middleware<D>>;
...
export declare type Encoders = Iterable<Encoder>;
export declare type WrappedEncoders = Iterable<WrappedEncoder>;
...
export declare type Decoders = Iterable<Decoder>;
export declare type WrappedDecoders = Iterable<WrappedDecoder>;
...
export declare type StreamDecoders = Iterable<StreamDecoder>;
export declare type WrappedStreamDecoders = Iterable<WrappedStreamDecoder>;
...
export declare type ResolverResult = CanUndef<CanArray<string>>;
...
export declare type RequestAPIValue<T = string> = Nullable<T> | ((params: MiddlewareParams) => Nullable<T>);
/**
 * A map of API parameters.
 *
 * These parameters apply if the original request URL is not absolute, and they can be used to customize the
...
export declare type NormalizedCreateRequestOptions<D = unknown> = typeof defaultRequestOpts & WrappedCreateRequestOptions<D>;
