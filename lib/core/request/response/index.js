...
var _helpers = require("../../../core/request/response/helpers");
...
let Response = (_dec = (0, _functools.deprecated)({
  ...
  constructor(body, opts) {
    ...
    this.ok = (0, _helpers.statusesContainStatus)(ok, this.status);
    this.hasNoContent = (0, _helpers.statusesContainStatus)(noContent, this.status);
  ...
  destroy() {
    ...
    Object.set(this, 'headers', new _headers.default());
    Object.delete(this, 'jsonReviver');
    Object.delete(this, 'parent');
    ['json', 'formData', 'document', 'text', 'blob', 'arrayBuffer', 'decode'].forEach(key => {
      this[key].cancelMemoize();
      Object.defineProperty(this, key, {
        configurable: true,
        enumerable: false,
        writable: false,
        value: () => _abortable.default.reject(new Error('This instance is destroyed'))
      });
    });
