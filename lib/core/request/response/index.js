...
let Response = (_class = class Response {
  ...
  document() {
    ...
    if (_env.IS_NODE) {
      ...
      return _abortable.default.resolve(this.text().then(text => new JSDOM(text)).then(res => Object.get(res, 'window.document')), this.parent);
    }

    if (Object.isString(body) || body instanceof ArrayBuffer) {
      return _abortable.default.resolve(this.text().then(text => {
    ...
    return _abortable.default.resolve(body, this.parent);
  }
  /**
  ...
  json() {
    ...
    if (body == null || body === '') {
      return _abortable.default.resolve(null, this.parent);
    }
    ...
    return _abortable.default.resolveAndCall(() => Object.cast(Object.size(this.decoders) > 0 && !Object.isFrozen(body) ? Object.fastClone(body) : body), this.parent);
  }
  /**
  ...
  blob() {
    ...
    if (body == null) {
      return _abortable.default.resolve(null);
    }
    ...
    const blob = new Blob([Object.cast(body)], {
      type: this.getHeader('content-type')
    });
    return _abortable.default.resolve(blob, this.parent);
  }
  /**
  ...
  text() {
    ...
    if (_env.IS_NODE) {
      ...
      return _abortable.default.resolve(String(body), this.parent);
    }
    ...
    if (Object.isDictionary(body)) {
      return _abortable.default.resolve(JSON.stringify(body), this.parent);
    }
    ...
    if (_env.IS_NODE) {
      return _abortable.default.resolve(Buffer.from(Object.cast(body)).toString(encoding));
    }
    ...
    if (typeof TextDecoder !== 'undefined') {
      ...
      return _abortable.default.resolve(decoder.decode(new DataView(Object.cast(body))), this.parent);
    }
