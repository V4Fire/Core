...
var stringEngine = _interopRequireWildcard(require("../../core/kv-storage/engines/string"));
...
const kv = {
  ...
  syncSessionString: (0, _kvStorage.factory)(stringEngine.syncSessionStorage),
  asyncSessionString: (0, _kvStorage.factory)(stringEngine.asyncSessionStorage, true)
};
