...
var _proxyReadonly = _interopRequireWildcard(require("../../../core/object/proxy-readonly"));
...
describe('core/object/proxy-readonly', () => {
  ...
  it('isReadonly', () => {
    expect((0, _proxyReadonly.isReadonly)(null)).toBeTrue();
    expect((0, _proxyReadonly.isReadonly)(1)).toBeTrue();
    expect((0, _proxyReadonly.isReadonly)('2')).toBeTrue();
    expect((0, _proxyReadonly.isReadonly)(true)).toBeTrue();
    expect((0, _proxyReadonly.isReadonly)(Object.freeze({}))).toBeTrue();
    expect((0, _proxyReadonly.isReadonly)((0, _proxyReadonly.default)({}))).toBeTrue();
    expect((0, _proxyReadonly.isReadonly)({})).toBeFalse();
  });
});