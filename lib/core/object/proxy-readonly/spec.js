...
describe('core/object/proxy-readonly', () => {
  ...
  it('Object.isExtensible', () => {
    ...
    expect(Object.isExtensible((0, _proxyReadonly.default)({}))).toBeFalse();
  ...
  it('Object.isSealed', () => {
    ...
    expect(Object.isSealed((0, _proxyReadonly.default)({}))).toBeTrue();
  ...
  it('Object.isFrozen', () => {
    ...
    expect(Object.isFrozen((0, _proxyReadonly.default)({}))).toBeTrue();
