...
describe('core/object/proxy-clone', () => {
  ...
  it('cloning an object with accessors', () => {
    ...
    const clone = (0, _proxyClone.default)(original);
    expect(() => clone.user.name = 'Jack').toThrowError("'set' on proxy: trap returned falsish for property 'name'");
    clone.user.age = 5;
  ...
  it('cloning an object with descriptors', () => {
    ...
    expect(() => clone.user.age = 12).toThrowError("'set' on proxy: trap returned falsish for property 'age'");
