...
var _lazy = _interopRequireDefault(require("../../core/lazy"));
...
describe('core/lazy', () => {
  it('should create a structure based on the passed function', () => {
    ...
    const lazyObj = (0, _lazy.default)(createObj, {
      a: 2,
      bla: Function
    });
    lazyObj.a++;
  ...
  it('should create a structure based on the passed class', () => {
    ...
    const LazyUser = (0, _lazy.default)(User, {
      config: {
        attr: {},
  ...
  it('creating two instances of the one lazy structure based on a class', () => {
    ...
    const LazyRenderEngine = (0, _lazy.default)(RenderEngine, {
      config: {
        attr: {},
        errorHandler: Function
      }
    ...
    const engine1 = new LazyRenderEngine(),
