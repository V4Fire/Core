...
const methodProperties = ['getMethod', 'peekMethod', 'addMethod', 'updateMethod', 'deleteMethod'];
exports.methodProperties = methodProperties;
const urlProperties = ['baseURL', 'advURL', 'socketURL', 'baseGetURL', 'basePeekURL', 'baseAddURL', 'baseUpdateURL', 'baseDeleteURL'];
