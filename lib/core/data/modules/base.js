...
class Provider extends _params.default {
  ...
  update(body, opts) {
    ...
    const req = this.request(url, this.resolver.bind(this), this.getRequestOptions('update', { ...opts,
      body,
      method
    }));
    return this.updateRequest(url, eventName, req);
  ...
  delete(body, opts) {
    ...
    const req = this.request(url, this.resolver.bind(this), this.getRequestOptions('delete', { ...opts,
      body,
      method
    }));
    return this.updateRequest(url, eventName, req);
