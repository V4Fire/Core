...
describe('core/json/stream', () => {
  ...
  describe('filters', () => {
    ...
    it('should combine several picks', async () => {
      ...
      const seq = seq((0, _stream.assemble)((0, _stream.pick)(tokens, 'total')), (0, _stream.assemble)((0, _stream.andPick)(tokens, 'data.0')), (0, _stream.assemble)((0, _stream.andPick)(tokens, '1', {
        from: 'array'
      })));
      const res = [];
