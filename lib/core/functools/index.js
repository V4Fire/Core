...
Object.keys(_deprecation).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _deprecation[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
...
Object.keys(_implementation).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _implementation[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
...
var _helpers = require("../../core/functools/helpers");
