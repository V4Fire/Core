...
var _middlewares = _interopRequireDefault(require("../../../core/request/context/modules/middlewares"));
...
class RequestContext extends _middlewares.default {
  ...
  static decorateContext(ctx, path, resolver, ...args) {
    const forkedCtx = Object.create(ctx),
          params = (0, _utils.merge)(ctx.params);
    params.path = path;
    ...
    const encoders = [],
          decoders = [];
    Object.forEach((0, _utils.merge)(ctx.encoders), (el, key) => {
      encoders.push(wrapProcessor('encoders', el, key));
    });
    Object.forEach((0, _utils.merge)(ctx.decoders), (el, key) => {
