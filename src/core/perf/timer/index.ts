...
import { PerfTimersRunner, PerfTimer } from '@src/core/perf/timer/impl';
import { getTimerEngine, createPredicates, PerfTimerConfig } from '@src/core/perf/config';

import type { PerfTimerFactory } from '@src/core/perf/timer/interface';

export * from '@src/core/perf/timer/interface';
