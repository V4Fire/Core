...
import { cmpLevels } from '@src/core/log/base';

import type { LogEvent, LogMiddleware } from '@src/core/log/middlewares';
import type { LogEngine } from '@src/core/log/engines';
