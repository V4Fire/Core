...
import { createStyleCache } from '@src/core/log/config/styles';

import type { LogStylesConfig, StylesCache } from '@src/core/log/config';
import type { LogEvent } from '@src/core/log/middlewares';

import type { LogLevel } from '@src/core/log/interface';
import type { LogEngine } from '@src/core/log/engines/interface';
