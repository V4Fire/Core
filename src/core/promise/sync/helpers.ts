...
import type { PromiseLikeP } from '@src/core/async';

import { weakMemoizeCache, longMemoizeCache } from '@src/core/promise/sync/const';
 ...
 * ```
 * memoize(nextTick());
 * memoize('@src/core/url/concat', () => import('@src/core/url/concat'));
 * ```
 */
