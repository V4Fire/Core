...
import { operations, compareRgxp, operandLengthErrorText } from '@src/core/semver/const';
import type { Operation, Strategy, ComparisonOptions } from '@src/core/semver/interface';

export * from '@src/core/semver/const';
export * from '@src/core/semver/interface';
