...
/** @see {@link DateConstructor.create} */
...
/** @see {@link DateConstructor.beginningOfDay} */
extend(Date, 'beginningOfDay', (date: Date) => date.beginningOfDay());

/** @see {@link Date.endOfDay} */
...
/** @see {@link DateConstructor.endOfDay} */
extend(Date, 'endOfDay', (date: Date) => date.endOfDay());

/** @see {@link Date.beginningOfWeek} */
...
/** @see {@link DateConstructor.beginningOfWeek} */
extend(Date, 'beginningOfWeek', (date: Date) => date.beginningOfWeek());

/** @see {@link Date.endOfWeek} */
...
/** @see {@link DateConstructor.endOfWeek} */
extend(Date, 'endOfWeek', (date: Date) => date.endOfWeek());

/** @see {@link Date.beginningOfMonth} */
...
/** @see {@link DateConstructor.beginningOfMonth} */
extend(Date, 'beginningOfMonth', (date: Date) => date.beginningOfMonth());

/** @see {@link Date.endOfMonth} */
...
/** @see {@link DateConstructor.beginningOfYear} */
extend(Date, 'beginningOfYear', (date: Date) => date.beginningOfYear());

/** @see {@link Date.endOfYear} */
...
/** @see {@link DateConstructor.endOfYear} */
