...
import { pluralizeText, generateText } from 'core/prelude/i18n';
	...
	describe('generateText', () => {
		...
		it('valid resolve macros', () => {
			const
				...
				result = generateText(string, {macros: 'bar'});
		...
		it('work with multiply macros', () => {
			const
				...
				result = generateText(string, {macros: 'bar', macros2: 'baz'});
