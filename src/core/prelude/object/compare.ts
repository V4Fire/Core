...
extend(Object, 'fastCompare', (a, b) => {
	...
	if (
		!aIsArr && !Object.isDictionary(a) && !Object.isDate(a) && !Object.isRegExp(a) && !Object.isFunction(a.toJSON) ||
		!bIsArr && !Object.isDictionary(b) && !Object.isDate(b) && !Object.isRegExp(b) && !Object.isFunction(b.toJSON)
	) {
