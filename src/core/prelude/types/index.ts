...
export const isIterableIterator = extend<typeof Object.isIterableIterator>(Object, 'isIterableIterator', (value) =>
	isIterator(value) && isIterable(value));
...
export const isAnyIterator = extend<typeof Object.isAnyIterator>(Object, 'isAnyIterator', (value) =>
	isIterator(value) || isAsyncIterator(value));

/** @see [[ObjectConstructor.isAnyIterable]] */
export const isAnyIterable = extend<typeof Object.isAnyIterable>(Object, 'isAnyIterable', (value) =>
