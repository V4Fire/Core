...
describe('core/prelude/types', () => {
	...
	it('`Object.isRegExp`', () => {
		expect(Object.isRegExp(/\d/)).toBe(true);
	...
	it('`Object.isArray`', () => {
		...
		expect(Object.isArray({length: 0})).toBe(false);
		expect(Object.isArray({length: 1, 0: 1})).toBe(false);
	...
	it('`Object.isArrayLike`', () => {
		...
		expect(Object.isArrayLike({length: 0})).toBe(true);
		expect(Object.isArrayLike({length: 1, 0: 1})).toBe(true);
		expect(Object.isArrayLike('')).toBe(true);
		expect(Object.isArrayLike('foo')).toBe(true);
		expect(Object.isArrayLike({0: 1})).toBe(false);
	...
	it('`Object.isSimpleObject`', () => {
		...
		expect(Object.isSimpleObject({[Symbol.toStringTag]: 'boom'})).toBe(false);
	});
	...
	it('`Object.isPromise`', () => {
		...
		expect(Object.isPromise({then: () => {}, catch: () => {}})).toBe(true);
		expect(Object.isPromise({then: () => {}})).toBe(false);
		expect(Object.isPromise(null)).toBe(false);
	});

	it('`Object.isPromiseLike`', () => {
		expect(Object.isPromiseLike(Promise.resolve())).toBe(true);
		expect(Object.isPromiseLike({then: () => {}})).toBe(true);
